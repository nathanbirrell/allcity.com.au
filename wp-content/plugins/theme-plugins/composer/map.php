...
// ==========================================================================================
  ...
  'params'          => array(
    ...
    array(
      ...
      'admin_label' => true,
      'dependency' => array( 'element' => 'broadcasts', 'value' => array('vimeo') ),
    ),
    array(
      'type'        => 'checkbox',
      'heading'     => 'Enable auto-play',
      'param_name'  => 'autoplay_vimeo_id',
    ...
    array(
      ...
      'description' => 'Add youtube video id e.g wjG99Kbp1qQ',
      'admin_label' => true,
      'dependency' => array( 'element' => 'broadcasts', 'value' => array('youtube') ),
    ),
    array(
      'type'        => 'checkbox',
      'heading'     => 'Enable auto-play',
      'param_name'  => 'autoplay_youtube_id',
      'description' => 'Enable autoplay',
      'admin_label' => true,
      'dependency' => array( 'element' => 'broadcasts', 'value' => array('youtube') ),
    ),
