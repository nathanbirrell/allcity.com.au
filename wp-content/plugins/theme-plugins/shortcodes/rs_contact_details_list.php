...
function rs_contact_details_list( $atts, $content = '', $id = '' ) {
  ...
  $output .=  '<li'.$text_color.'><i class="fa fa-phone"'.$icon_color.'></i><button data-clipboard-text="03 9571 7000" class="copy-to-clipboard" title="Click to copy">'.esc_html($phone_no).'</button></li>';
