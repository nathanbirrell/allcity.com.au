...
function sturlly_parent_styles() {
	...
	wp_enqueue_style('allcity_style', get_stylesheet_directory_uri() . '/assets/css/style.css', array('custom-style','portfolio-style','fancybox','scrollbar','responsive','prettyPhoto','bootstrap','animation','fontawesome'));
