...
function sturlly_parent_styles() {
	...
	wp_enqueue_style('allcity_style', get_stylesheet_directory_uri() . '/assets/css/style.css');
	wp_enqueue_script('allcity_script', get_stylesheet_directory_uri() . '/assets/js/script.js');
}
